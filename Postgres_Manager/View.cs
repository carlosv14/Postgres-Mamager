...
namespace Postgres_Manager
{
    public partial class View : Form
    {
        ...
        private void UpdateLineNumbers(int startingAtLine)
        {
            ...
            for (int i = startingAtLine; i < richTextBox2.Lines.Count; i++)
            {
                richTextBox2.Lines[i].MarginStyle = Style.LineNumber;
                richTextBox2.Lines[i].MarginText = i.ToString();
            }
        }

        private void UpdateLineNumbers1(int startingAtLine)
        {
        ...
        private void richTextBox2_Insert(object sender, ModificationEventArgs e)
        {
            if (e.LinesAdded != 0)
                UpdateLineNumbers(richTextBox2.LineFromPosition(e.Position));
        }

        private void richTextBox2_Delete(object sender, ModificationEventArgs e)
        {
            if (e.LinesAdded != 0)
                UpdateLineNumbers(richTextBox2.LineFromPosition(e.Position));
        }
        ...
        {
            if (e.LinesAdded != 0)
                UpdateLineNumbers1(richTextBox1.LineFromPosition(e.Position));
        }
